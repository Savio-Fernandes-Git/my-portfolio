    ...
    return (
        ...
        <div data-aos="fade-up" data-aos-duration="2000" className="project grid grid-cols-1 md:grid-cols-2 grid-flow-row m-32 mt-14 gap-12">
            <div>
                ...
                <a href="https://fireegram.netlify.app/" target="_blank" rel='noreferrer'>
                    <p className="web-code-text p-2">View Website</p>
                </a>
                <a href="https://github.com/Savio-Fernandes-Git/firegram" target="_blank" rel='noreferrer'>
            ...
            <div>
                ...
                <div className="web-code">
                <a href="https://exp-ensetracker.netlify.app/" target="_blank" rel='noreferrer'>
                    <p className="web-code-text p-2">View Website</p>
                </a>
                <a href="https://github.com/Savio-Fernandes-Git/exp-tracker" target="_blank" rel='noreferrer'>
                    <p className="web-code-text p-2">View Code</p>
                </a>
                </div>
            </div>
