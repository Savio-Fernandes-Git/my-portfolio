            ...
            >
                <div>
                    ...
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                        <p className="mt-4 text-xl">
                            Full Stack Software Engineer | Cargo LLC{" "}
                        </p>
                        <p>August 2021 – September 2022</p>
                        <ul>
                            <li className="mt-4 ml-2">
                                - Created RESTful APIs to serve web & mobile
                    ...
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                        <p className="mt-4 text-xl">
                            IT Student Computing Assistant - Level 1 Tech
                            Support | Maynooth University{" "}
                        </p>
                        <p>October 2022 – Present</p>
                        <ul>
                            <li className="mt-4 ml-2">
                                - Performed level 1 tech support.
                            </li>
                            <li className="mt-4 ml-2">
                                - Experience in troubleshooting common tech
                                problems.
                            </li>
                            <li className="mt-4 ml-2">
                                - Worked at the library front desk to cater to
                                peer requirements.
                            </li>
                            <li className="mt-4 ml-2 mb-8">
                                - Experience in navigating azure AD and user
                ...
                <div>
                    ...
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                        ...
                        <ul>
                            <li className="mt-4 ml-2">
                                - Computer science program focussed on Software
                    ...
                    <div data-aos="zoom-out-right" data-aos-duration="2000">
                        ...
                        <ul>
                            <li className="mt-4 ml-2 mb-8">
                                - 3.10 CGPA in ABET certified Computer
                                Engineering Program.
                            </li>
                        </ul>
                    </div>
