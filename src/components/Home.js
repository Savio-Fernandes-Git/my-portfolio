...
export default function Home() {
    ...
    return (
        ...
        <div className="home grid grid-cols-1 md:grid-cols-1 grid-flow-column gap-12 m-2">
            ...
            <motion.div variants={buttonVariants} whileHover="hover" data-aos="fade-up" data-aos-duration="2000">
                <a href="https://www.linkedin.com/in/savio15/" target="_blank" rel='noreferrer'>
                    <FaLinkedin style={{ height:100, width:100 }}/>
                    <p className="ml-4 mt-4">LinkedIn</p>
                </a>
            </motion.div>
            <motion.div variants={buttonVariants} whileHover="hover" data-aos="fade-up" data-aos-duration="2000">
                <a href="https://github.com/Savio-Fernandes-Git" target="_blank" rel='noreferrer'>
                    <DiGithubBadge style={{ height:100, width:100 }}/>
                    <p className="ml-6 mt-4">GitHub</p>
                </a>
            </motion.div>
            <motion.div variants={buttonVariants} whileHover="hover" data-aos="fade-up" data-aos-duration="2000">
                <a href="mailto:savio-f-tech@gmail.com" target="_blank" rel='noreferrer'>
                    <BiMailSend style={{ height:100, width:100 }}/>
                    <p className="ml-10 mt-4">Mail</p>
                </a>
            </motion.div>
            </div>
        </div>
